                ...
                <div class="modal-body">
                  <form method="POST" action={{route('admin.department.store')}}>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          {{ Form::label('department_information', 'Department Information:') }}
                          {{ Form::text('department_information', null ,['class' => 'form-control', 'placeholder' => 'Enter department information']) }}
                      </div>
           ...
           <table class="table table-bordered" id="example">
               ...
               <tbody>
                   ...
                   <tr>
                       ...
                       <td>{{ $dep->department_information }}</td>
