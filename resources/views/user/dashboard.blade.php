    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-8 ftco-animate text-center">
          <h1 class="mb-4">The most wealth is health</h1>
      ...
      <div class="row no-gutters">
        <div class="col-md-4 ftco-animate py-5 nav-link-wrap">
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link px-4 active" id="v-pills-master-tab" data-toggle="pill" href="#v-pills-master" role="tab" aria-controls="v-pills-master" aria-selected="true"> @foreach($department as $depart)
  ...
  <section class="ftco-section">
      ...
      <div class="row">
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="block-2">
              <div class="flipper">
                <div class="front" style="background-image: url(foruser/images/anand.jpg);">
                  <div class="box">
                    <h2>Dr. Anand Ghimire </h2>
                ...
                <div class="back">
                  <!-- back content -->
                  <blockquote>
                    <p>Consultant, ENT Head & Neck Surgeon “Head of the Department of ENT”.</p>
                  </blockquote>
                  <div class="author d-flex">
                    <div class="image mr-3 align-self-center">
                      <div class="img" style="background-image: url(foruser/images/anand.jpg);"></div>
                    </div>
                    <div class="name align-self-center">Dr. Anand Ghimire <span class="position">Otorhinolaryngology</span></div>
                  </div>
                </div>
              </div>
            </div> <!-- .flip-container -->
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="block-2">
              <div class="flipper">
                <div class="front" style="background-image: url(foruser/images/jenusuwal.jpg);">
                  <div class="box">
                    <h2>Dr. Jenu Suwal Dongol</h2>
                    <p>Otorhinolaryngology</p>
                  </div>
                </div>
                <div class="back">
                  ...
                  <div class="author d-flex">
                    <div class="image mr-3 align-self-center">
                      <div class="img" style="background-image: url(foruser/images/jenusuwal.jpg)"></div>
                    </div>
                    <div class="name align-self-center">Dr. Jenu Suwal Dongol <span class="position">Otorhinolaryngology</span></div>
                  </div>
                </div>
              </div>
            </div> <!-- .flip-container -->
      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2">Hospital System</h2>
                ...
                <select name="appointment_day" class="form-control" id="appointment_day">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="adate" id="adate">
                      <span>Note* Doctor is only available from 10 A.M. to 12 P.M.</span>
                  </div>

                {{--<div class="col-md-6">--}}
                    {{--<div class="form-group">--}}
                        {{--<label for="comment" class="text-black">Message</label>--}}
